...
class Config(object):
    ...
    MAX_TG_SPLIT_FILE_SIZE = int(os.environ.get("MAX_TG_SPLIT_FILE_SIZE", 1597152000))
    ...
    DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "KS-VideoFile")
